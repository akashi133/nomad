      ...
      <div className="columns" data-aos="fade-right" data-aos-delay="300">
        ...
        <ul>
          ...
          <li>
            <p>
              <span>
                <FormattedMessage id="years1" defaultMessage="Age:" />
              </span>
            </p>
          </li>
          <li>
            <p>
              <span>
                <FormattedMessage id="years2" defaultMessage="Age:" />
              </span>
            </p>
          </li>
          <li>
            <p>
              <span>
                <FormattedMessage id="years3" defaultMessage="Age:" />
              </span>
            </p>
          </li>
          <li>
            <p>
              <span>
                <FormattedMessage id="years4" defaultMessage="Age:" />
              </span>
            </p>
          </li>
          <li>
            <p>
              <span>
                <FormattedMessage id="years5" defaultMessage="Age:" />
              </span>
            </p>
          </li>
        </ul>
